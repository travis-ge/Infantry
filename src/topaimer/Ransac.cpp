...
//     * @return 半径&圆心
//     */
//    std::pair<double, cv::Point2d> Ransac::fitCircle(std::vector<Armour> &armor_seq)
//    {
//        // 初始化数据
...
//     * @return 半径&圆心
//     */
//    std::pair<double, cv::Point2d> Ransac::getCircle(Armour &armor1, Armour &armor2, Armour &armor3)
//    {
...
//     * @return 包含内点比例
//     */
//    float Ransac::verifyCircle(double radius, cv::Point2d center, std::vector<Armour> &armor_seq)
//    {
//        int inlier_cnt = 0;
