...
//}
//
//void StaticAimer::buildModel(Armour &armor) {
//    // 转绝对坐标
...
//                    m_palstance = (CV_PI / 2) *100000/ m_time_diff;
//                    // 判断角速度方向
...
//}
//
//Ptz_infor StaticAimer::getTargetPose(Armour &) {
//    int no = m_armor_no;
//    Ptz_infor final_pose;
//    double time_now = tool::getTimeNow();
//    // 预计击中时刻
//    double time_next = time_now + m_time_delay + m_armor_target[m_armor_no].m_position.x / m_bullet_speed;
//    // 提前量时长
//    double time_len = (m_angle_predict * CV_PI / 180) / m_palstance;
//
